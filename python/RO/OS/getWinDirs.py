...
def getAppDirs(inclNone = False):
    r"""Return up to two paths: the user's private and shared applications directory.
...
def getAppSuppDirs(inclNone = False):
    r"""Return up to two paths: the user's private and shared application support directory.
...
def getDocsDir():
    r"""Return the path to the user's documents directory.
...
def getPrefsDirs(inclNone = False):
    r"""Return up to two paths: the user's private and shared preferences directory.
