...
class MessageTests(unittest.TestCase):
	...
	def test05(self):
		"Reply headers"
		hdr = ReplyHeader('prog','user',123,'actor',':')
		self.assertEqual(hdr.code,ReplyHeader.MsgCode('FINISHED'))
		self.assertRaises(ValueError,lambda: ReplyHeader('prog','user','abc','actor','!'))
		self.assertRaises(MessageError,lambda: ReplyHeader('prog','user',123,'actor','?'))
